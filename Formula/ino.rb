class Ino < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/i/ino/ino-0.3.6.tar.gz"
...
#    sha256 "cf60e506818d1add5939a547f5675bd6b2f2f7ff31af5eedde385f1dc4b1e954" => :mojave
  ...
  resource "configobj" do
    url "https://files.pythonhosted.org/packages/source/c/configobj/configobj-5.0.5.tar.gz"
    sha256 "766eff273f2cbb007a3ea8aa69429ee9b1553aa96fe282c6ace3769b9ac47b08"
  end

  resource "pyserial" do
    url "https://files.pythonhosted.org/packages/source/p/pyserial/pyserial-2.7.tar.gz"
    sha256 "3542ec0838793e61d6224e27ff05e8ce4ba5a5c5cc4ec5c6a3e8d49247985477"
  end

  resource "six" do
    url "https://files.pythonhosted.org/packages/source/s/six/six-1.7.2.tar.gz"
